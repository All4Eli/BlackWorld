...
export const BS_SHOP_ITEMS = [
  { key: 'protection_scroll', name: 'Enhancement Protection Scroll', cost: 50, icon: '📜', desc: 'Prevents item break on one failed enhancement', category: 'utility' },
  { key: 'essence_refill', name: 'Essence Refill', cost: 20, icon: '⚗️', desc: 'Instantly refills Blood Essence to max', category: 'utility' },
  ...
  { key: 'name_color_crimson', name: 'Name Color: Crimson', cost: 300, icon: '🔴', desc: 'Permanent crimson name color', category: 'cosmetic' },
  { key: 'name_color_amber', name: 'Name Color: Amber', cost: 300, icon: '🟠', desc: 'Permanent amber name color', category: 'cosmetic' },
  { key: 'name_color_void', name: 'Name Color: Void', cost: 300, icon: '🟣', desc: 'Permanent void purple name color', category: 'cosmetic' },
  { key: 'loot_charm', name: 'Loot Charm (24h)', cost: 30, icon: '🍀', desc: '+10% loot drop chance for 24 hours', category: 'booster' },
  { key: 'xp_incense', name: 'XP Incense (24h)', cost: 30, icon: '🕯️', desc: '+15% XP gain for 24 hours', category: 'booster' },
  { key: 'flask_restock', name: 'Flask Restock', cost: 15, icon: '🧪', desc: 'Refill all combat flasks immediately', category: 'utility' },
];
